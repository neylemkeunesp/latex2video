...
"""
    ...
    def test_parse_latex_file(self, mock_run):
        ...
        # The parser creates slides to match the PDF page count (title, outline, and content/continuation slides)
        # For our sample, it estimates 10 slides (8 frames + 2)
        ...
        self.assertTrue(any("FORMULA: E = mc^2" in s.content for s in slides))
