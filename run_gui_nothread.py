#!/usr/bin/env python3
"""
Helper script to run the LaTeX2Video GUI without threading.
...
class LaTeX2VideoGUI:
    """Main GUI application for LaTeX2Video - No Threading Version"""
    def __init__(self, root):
        self.root = root
        self.root.title("LaTeX2Video (No Threading)")
    ...
    def generate_images(self):
        """Generate images from the LaTeX file - NO THREADING VERSION"""
    ...
    def generate_audio(self):
        """Generate audio files from narration scripts - NO THREADING VERSION"""
        if not self.load_config():
            return
    ...
    def assemble_video(self):
        """Assemble the final video from images and audio - NO THREADING VERSION"""
        if not self.load_config():
            return
    ...
    def generate_all(self):
        """Generate everything: images, audio, and video - NO THREADING VERSION"""
        if not self.load_config():
            return
...
def main():
    ...
    # Try to run the GUI
    try:
        print("Attempting to run LaTeX2Video GUI (No Threading Version)...")
